...
import com.example.springbootchatgpt.enums.StatusCodeEnum;
...
public class ExceptionHandlerConfig {
     ...
     * @return
     */
    @ExceptionHandler(value = ChatGptException.class)
    @ResponseBody
    public Result exceptionHandler(HttpServletRequest req, ChatGptException ex) {
